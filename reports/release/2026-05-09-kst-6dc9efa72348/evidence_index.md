...
- API contract: `docs/api/PRODUCT_API.md`, `docs/api/OPENAPI_LIKE.yaml`
- HTTP adapter evidence: `reports/productization/PR2_HTTP_ADAPTER_EVIDENCE.md`
- MCP registration evidence: `reports/productization/PR3_MCP_SAFE_RUNTIME_EVIDENCE.md`
- Product API for n8n: `reports/productization/phase19_product_api_contract_for_n8n.md`
